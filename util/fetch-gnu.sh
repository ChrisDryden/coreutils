...
# Remove tests that no longer exist on master
rm -f tests/rm/fail-eperm.xpl
...
curl -L ${repo}/raw/refs/heads/master/tests/rm/fail-2eperm.sh > tests/rm/fail-2eperm.sh
