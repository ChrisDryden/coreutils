...
if [ "${SELINUX_ENABLED}" = 1 ];then
    ...
    "${MAKE}" UTILS="cat chcon chmod cp cut dd echo env groups id ln ls mkdir mkfifo mknod mktemp mv printf realpath rm rmdir runcon stat test touch tr true uname wc whoami"
else
